    ...
    <section className="home-page">
      <div className="hero-panel">
        ...
        <div className="hero-image-card">
          <img
            src={MinhaImagem}
            alt="Golden retriever em destaque na vitrine do petshop"
          />
          <div className="hero-image-overlay">
            <strong>Experiencia mais acolhedora</strong>
            <span>
              Imagem, hierarquia e contexto para dar mais valor ao projeto.
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="home-grid">
        <div>
          ...
          <h2 className="section-title">
            Elementos que fazem o projeto parecer pronto para uso
          </h2>
          <p className="section-copy">
            Quem olha um sistema decide em segundos se ele parece confiavel.
            Estas melhorias ajudam a contar uma historia melhor sem alterar a
            base funcional que voce ja tem.
          </p>
          ...
          <div className="feature-list">
            <article className="feature-card">
              ...
              <p>
                Titulos, blocos e destaques agora guiam o olhar em vez de
                competir entre si.
              </p>
              <span className="feature-meta">
                Melhora imediata na apresentacao
              </span>
            </article>
            ...
            <article className="feature-card">
              ...
              <p>
                Os acessos principais foram reposicionados para parecerem parte
                de um produto de verdade.
              </p>
              <span className="feature-meta">
                Mais contexto para recrutadores e clientes
              </span>
            </article>
            ...
            <article className="feature-card">
              ...
              <p>
                A area operacional fica mais escaneavel com cards, resumos e
                tabelas melhor organizadas.
              </p>
              <span className="feature-meta">
                Fluxo mais facil de demonstrar
              </span>
            </article>
          </div>
        </div>
        ...
        <div className="insight-list">
          <article className="insight-card">
            ...
            <p>
              Agora a interface comunica operacao de petshop: pessoas, animais e
              produtos conectados pela mesma experiencia.
            </p>
          </article>
          ...
          <article className="insight-card">
            ...
            <p>
              Uma home com narrativa visual e uma area de gestao mais
              consistente elevam muito a percepcao de qualidade.
            </p>
          </article>
        </div>
      </div>
